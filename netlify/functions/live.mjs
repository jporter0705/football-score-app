...
export default async request=>{
  ...
  try{
    ...
    const h=await readWeek(key);h.sources=h.sources||{};const results=await Promise.allSettled([liveScores('nfl',current),liveScores('college',current)]);
